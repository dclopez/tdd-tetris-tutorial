...
public class Step1_FallingBlocksTest extends Assert {
	...
	public void it_is_still_falling_on_the_last_row() {
		...
		board.tick();
		assertEquals("" + "...\n" + "...\n" + ".X.\n", board.toString());
		assertTrue("the player should still be able to move the block",
				board.hasFalling());
	}
	...
	public void it_is_still_falling_right_above_the_other_block() {
		...
		assertEquals("" + "...\n" + ".Y.\n" + ".X.\n", board.toString());
		assertTrue(
				"the player should still be able to avoid landing on the other block",
				board.hasFalling());
	}
	...
	public void it_stops_when_it_hits_the_other_block() {
		...
		assertEquals("" + "...\n" + ".Y.\n" + ".X.\n", board.toString());
		assertFalse(
				"the block should stop moving when it lands on the other block",
				board.hasFalling());
	}
